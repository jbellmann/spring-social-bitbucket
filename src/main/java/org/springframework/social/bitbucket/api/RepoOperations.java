...
public interface RepoOperations {
    ...
    /**
     * Adds a new deploy-key to the repository.
     */
    List<BitBucketDeployKey> addDeployKey(String user, String repoSlug,
            String keyContent, String label);

    /**
     * Add a new POST-service hook.
     */
    List<BitBucketService> addService(String user, String repoSlug, String url);
}
